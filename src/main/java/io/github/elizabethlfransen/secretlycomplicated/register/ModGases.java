...
public class ModGases {
    ...
    public static final SCMaterial sulfuric_gas = new SCMaterialBuilder()
            ...
            .withForms(CommonMaterialFormFactories.GASES)
            .build();
    public static final SCMaterial refinery_gas = new SCMaterialBuilder()
            .name("refinery_gas") // It is typically made of methane and ethane, but can also have some propane, butane, and hydrogen in it.
            .color(0xffffff)
            .melting(9999)
            .boiling(9999)
            .withForms(CommonMaterialFormFactories.GASES)
    ...
    public static final SCMaterial carbon_monoxide = new SCMaterialBuilder()
            ...
            .withForms(CommonMaterialFormFactories.GASES)
            .build();
    public static final SCMaterial ethylene = new SCMaterialBuilder()
            .name("ethylene")
            .color(0xe1e1e1)
            .melting(9999)
            .boiling(9999)
    ...
    public static final SCMaterial deuterium = new SCMaterialBuilder()
            ...
            .withForms(CommonMaterialFormFactories.GASES)
            .build();
    public static final SCMaterial propylene = new SCMaterialBuilder()
            .name("propylene")
            .color(0xffffff)
            .melting(9999)
            .boiling(9999)
