...
public class SimpleItemMaterialForm implements MaterialForm, Localizable, ItemForm {
    ...
    public SimpleItemMaterialForm(Item item, String textureName, int color, Function<String, String> localizedName) {
        this.item = item;
